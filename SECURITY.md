...
- **Acknowledgment:** within 7 days of the advisory being filed.
...
- Behavior that is documented and intended. For example, a Vega spec author has full control over the visual's expression evaluation within the sandbox; this is by design and is the basis of Deneb's threat model.
