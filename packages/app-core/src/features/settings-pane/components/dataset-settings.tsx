 ...
 */
const COLUMN_FLAGS = ['format', 'formatted'] as const;
 ...
 */
const FLAG_INFO: Partial<Record<string, string>> = {
...
const encodeValue = (fieldName: string, flag: string): string =>
    `${fieldName}${VALUE_SEPARATOR}${flag}`;

/** Decode a TreeItem value into [fieldName, flagKey]. */
const decodeValue = (value: string): [string, string] => {
