...
export default class DisplaySettings extends SettingsBase {
    ...
    public scrollbarColor: string = SETTINGS_DEFAULTS.display.scrollbarColor;
    // Opacity of displayed scrollbars
    public scrollbarOpacity: number =
        SETTINGS_DEFAULTS.display.scrollbarOpacity;
    // Radius of displayed scrollbars
    public scrollbarRadius: number =
        SETTINGS_DEFAULTS.display.scrollbarRadius.default;
    ...
    public getFormattingCard = (): FormattingCard => {
        ...
        const SCROLLBAR_RADIUS_SLICE: IIntegerSliceOptions = {
            ...
            slider: true,
            minValue: SETTINGS_DEFAULTS.display.scrollbarRadius.min,
            maxValue: SETTINGS_DEFAULTS.display.scrollbarRadius.max,
            unitSymbol: 'px',
            unitSymbolAfterInput: true
        };
        return {
